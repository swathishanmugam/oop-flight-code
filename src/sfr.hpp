...
namespace sfr {
    ...
    namespace camera {
        ...
        extern uint16_t resolution_get_delay;
    ...
    namespace overrideable {
        ...
        // OP Codes are ordered Bools, Ints, Floats, ... //TODO
        extern const int n_bools;
        extern const int n_ints;
        extern const int n_floats;
        extern const int n_overridable;
        extern const bool *editable_bools[];   // Editable Bool Fields
        extern const int *editable_ints[];     // Editable Int Fields
        extern const float *editable_floats[]; // Editable Float Fields
    }                                          // namespace overrideable
};                                             // namespace sfr
