...
namespace sfr {
    ...
    namespace camera {
        ...
        uint16_t resolution_get_delay = 200;
    ...
    namespace overrideable {
        ...
        const int n_bools = 35;
        const int n_ints = 28;
        const int n_floats = 35;
        const int n_overridable = n_bools + n_ints + n_floats;
        // Editable Bool Fields
        const bool *editable_bools[n_bools] = {
            &sfr::aliveSignal::downlinked,
            &sfr::photoresistor::covered,
            &sfr::mission::deployed,
            &sfr::mission::already_deployed,
            &sfr::burnwire::fire,
            &sfr::burnwire::arm,
            &sfr::camera::photo_taken_sd_failed,
            &sfr::camera::take_photo,
            &sfr::camera::turn_on,
            &sfr::camera::turn_off,
            &sfr::camera::powered,
            &sfr::camera::fragment_requested,
            &sfr::camera::report_ready,
            &sfr::camera::full_image_written,
            &sfr::camera::report_downlinked,
            &sfr::rockblock::rockblock_ready_status,
            &sfr::rockblock::waiting_message,
            &sfr::rockblock::imu_first_start,
            &sfr::rockblock::imu_downlink_on,
            &sfr::rockblock::flush_status,
            &sfr::rockblock::waiting_command,
            &sfr::rockblock::sleep_mode,
            &sfr::imu::successful_init,
            &sfr::imu::sample,
            &sfr::imu::sample_gyro,
            &sfr::imu::report_ready,
            &sfr::imu::report_downlinked,
            &sfr::imu::report_written,
            &sfr::imu::full_report_written,
            &sfr::temperature::in_sun,
            &sfr::current::in_sun,
            &sfr::acs::off,
            &sfr::button::pressed,
            &sfr::EEPROM::alloted_time_passed};
        // Editable Int Fields
        const int *editable_ints[n_ints] = {
            &sfr::detumble::num_imu_retries,
            &sfr::detumble::max_imu_retries,
            &sfr::aliveSignal::max_downlink_hard_faults,
            &sfr::aliveSignal::num_hard_faults,
            &sfr::photoresistor::val,
            &sfr::burnwire::attempts,
            &sfr::burnwire::start_time,
            &sfr::burnwire::camera_attempts,
            &sfr::burnwire::burn_time,
            &sfr::burnwire::armed_time,
            &sfr::camera::current_serial,
            &sfr::camera::fragment_number,
            &sfr::camera::fragment_number_requested,
            &sfr::camera::serial_requested,
            &sfr::camera::images_written,
            &sfr::camera::fragments_written,
            &sfr::rockblock::max_commands_count,
            &sfr::rockblock::imu_max_fragments,
            &sfr::imu::gyro_min,
            &sfr::imu::gyro_max,
            &sfr::imu::mag_min,
            &sfr::imu::mag_max,
            &sfr::imu::max_fragments,
            &sfr::imu::content_length,
            &sfr::EEPROM::time_of_last_write,
            &sfr::EEPROM::write_step_time,
            &sfr::EEPROM::alloted_time,
            &sfr::EEPROM::eeprom_value};
        // Editable Float Fields
        const float *editable_floats[n_floats] = {
            &sfr::stabilization::max_time,
            &sfr::simple::max_time,
            &sfr::point::max_time,
            &sfr::detumble::start_time,
            &sfr::detumble::max_time,
            &sfr::detumble::min_stable_gyro_z,
            &sfr::detumble::max_stable_gyro_x,
            &sfr::detumble::max_stable_gyro_y,
            &sfr::detumble::min_unstable_gyro_x,
            &sfr::detumble::min_unstable_gyro_y,
            &sfr::aliveSignal::max_time,
            &sfr::mission::time_deployed,
            &sfr::mission::acs_transmit_cycle_time,
            &sfr::rockblock::imudownlink_start_time,
            &sfr::rockblock::imudownlink_remain_time,
            &sfr::rockblock::start_time_check_signal,
            &sfr::rockblock::max_check_signal_time,
            &sfr::imu::mag_x,
            &sfr::imu::mag_y,
            &sfr::imu::mag_z,
            &sfr::imu::gyro_x,
            &sfr::imu::gyro_y,
            &sfr::imu::gyro_z,
            &sfr::temperature::temp_c,
            &sfr::current::solar_current,
            &sfr::acs::current1,
            &sfr::acs::current2,
            &sfr::acs::current3,
            &sfr::acs::pwm1,
            ...
            &sfr::acs::on_time,
            &sfr::battery::voltage,
            &sfr::battery::acceptable_battery,
            &sfr::battery::min_battery};
